...
function loadPayload672WithStatus(payloadPath) {
  ...
  LoadPayload672 = function LoadPayload672() {
    try {
  ...
  _loadSettings = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7() {
    ...
    return _regenerator().w(function (_context7) {
      while (1) switch (_context7.p = _context7.n) {
        case 0:
          _context7.p = 0;
          // PS_DEALS_BH exposes GoldHEN only, so keep hidden legacy selectors in sync.
          user.currentJbFlavor = 'GoldHEN';
          localStorage.setItem('jailbreakFlavor', 'GoldHEN');
          localStorage.setItem('GHVer', 'GHv2.4b18.10');
          CheckFW();
          loadJbFlavor();
          _context7.n = 1;
          return initLanguage();
